...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f4f4f4] text-black font-['Fredoka']">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-md border-b-4 border-black">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-20">
            {/* Logo */}
            <div className="flex items-center space-x-2">
              <div className="w-10 h-10 bg-[#2e8b57] rounded-xl flex items-center justify-center border-2 border-black">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="#home" className="font-bold hover:text-[#2e8b57] transition-colors">Home</a>
              <a href="#features" className="font-bold hover:text-[#2e8b57] transition-colors">Features</a>
              <a href="#events" className="font-bold hover:text-[#2e8b57] transition-colors">Events</a>
              <a href="#testimonials" className="font-bold hover:text-[#2e8b57] transition-colors">Testimonials</a>
              <a href="#contact" className="font-bold hover:text-[#2e8b57] transition-colors">Contact</a>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-4">
              {!isLoggedIn ? (
                <>
                  <button 
                    onClick={toggleLogin}
                    className="flex items-center gap-2 px-4 py-2 border-2 border-black rounded-xl font-bold hover:bg-zinc-100 transition-colors"
                  >
                    <LogIn className="w-4 h-4" />
                    Log in
                  </button>
                  <button className="flex items-center gap-2 px-4 py-2 bg-[#2e8b57] text-white border-2 border-black rounded-xl font-bold hover:bg-[#236b43] transition-colors shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                ...
                <button 
                  onClick={toggleLogin}
                  className="flex items-center gap-2 px-4 py-2 bg-red-500 text-white border-2 border-black rounded-xl font-bold hover:bg-red-600 transition-colors"
                >
                  Log out
                </button>
              )}
              ...
              <div className="flex flex-col space-y-4">
                ...
                {!isLoggedIn ? (
                  <div className="flex items-center space-x-4 pt-2">
                    <button onClick={toggleLogin} className="flex-1 px-4 py-2 border-2 border-black rounded-xl font-bold">Log in</button>
                    <button className="flex-1 px-4 py-2 bg-[#2e8b57] text-white border-2 border-black rounded-xl font-bold shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                      Sign up
                    </button>
                  </div>
                ) : (
                  <button onClick={toggleLogin} className="px-4 py-2 bg-red-500 text-white border-2 border-black rounded-xl font-bold">
                    Log out
                  </button>
                )}
              </div>
